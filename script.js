...
// ====== TỰ BẬT NHẠC NỀN KHI MÍT CHẠM MÀN HÌNH LẦN ĐẦU ======
document.addEventListener('touchstart', function playMusicOnce() {
    const music = document.getElementById('bgMusic');
    if (music && music.paused) {
        music.volume = 0.5; // Âm lượng vừa phải 50%
        music.play().catch(() => {});
    }
    // Chỉ kích hoạt 1 lần duy nhất ở cú chạm đầu tiên
